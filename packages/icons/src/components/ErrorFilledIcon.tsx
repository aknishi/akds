...
export interface ErrorFilledIconProps extends Omit<React.SVGProps<SVGSVGElement>, 'width' | 'height' | 'color'> {
...
export const ErrorFilledIcon = React.forwardRef<SVGSVGElement, ErrorFilledIconProps>(
  function ErrorFilledIcon({ size = 'md', color = 'default', className, style, ...props }, ref) {
