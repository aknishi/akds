...
export interface KeyboardArrowLeftIconProps extends Omit<React.SVGProps<SVGSVGElement>, 'width' | 'height' | 'color'> {
...
export const KeyboardArrowLeftIcon = React.forwardRef<SVGSVGElement, KeyboardArrowLeftIconProps>(
  function KeyboardArrowLeftIcon({ size = 'md', color = 'default', className, style, ...props }, ref) {
