...
export interface RestartIconProps extends Omit<React.SVGProps<SVGSVGElement>, 'width' | 'height' | 'color'> {
...
export const RestartIcon = React.forwardRef<SVGSVGElement, RestartIconProps>(
  function RestartIcon({ size = 'md', color = 'default', className, style, ...props }, ref) {
