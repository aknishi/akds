...
export interface CheckCircleIconProps extends Omit<React.SVGProps<SVGSVGElement>, 'width' | 'height' | 'color'> {
...
export const CheckCircleIcon = React.forwardRef<SVGSVGElement, CheckCircleIconProps>(
  function CheckCircleIcon({ size = 'md', color = 'default', className, style, ...props }, ref) {
