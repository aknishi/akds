...
export interface ShieldLockIconProps extends Omit<React.SVGProps<SVGSVGElement>, 'width' | 'height' | 'color'> {
...
export const ShieldLockIcon = React.forwardRef<SVGSVGElement, ShieldLockIconProps>(
  function ShieldLockIcon({ size = 'md', color = 'default', className, style, ...props }, ref) {
