...
export interface SettingsFilledIconProps extends Omit<React.SVGProps<SVGSVGElement>, 'width' | 'height' | 'color'> {
...
export const SettingsFilledIcon = React.forwardRef<SVGSVGElement, SettingsFilledIconProps>(
  function SettingsFilledIcon({ size = 'md', color = 'default', className, style, ...props }, ref) {
