...
export interface GroupIconProps extends Omit<React.SVGProps<SVGSVGElement>, 'width' | 'height' | 'color'> {
...
export const GroupIcon = React.forwardRef<SVGSVGElement, GroupIconProps>(
  function GroupIcon({ size = 'md', color = 'default', className, style, ...props }, ref) {
