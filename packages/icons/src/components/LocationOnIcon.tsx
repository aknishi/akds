...
export interface LocationOnIconProps extends Omit<React.SVGProps<SVGSVGElement>, 'width' | 'height' | 'color'> {
...
export const LocationOnIcon = React.forwardRef<SVGSVGElement, LocationOnIconProps>(
  function LocationOnIcon({ size = 'md', color = 'default', className, style, ...props }, ref) {
