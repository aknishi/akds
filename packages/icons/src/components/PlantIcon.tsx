...
export interface PlantIconProps extends Omit<React.SVGProps<SVGSVGElement>, 'width' | 'height' | 'color'> {
...
export const PlantIcon = React.forwardRef<SVGSVGElement, PlantIconProps>(
  function PlantIcon({ size = 'md', color = 'default', className, style, ...props }, ref) {
