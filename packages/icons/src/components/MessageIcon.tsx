...
export interface MessageIconProps extends Omit<React.SVGProps<SVGSVGElement>, 'width' | 'height' | 'color'> {
...
export const MessageIcon = React.forwardRef<SVGSVGElement, MessageIconProps>(
  function MessageIcon({ size = 'md', color = 'default', className, style, ...props }, ref) {
