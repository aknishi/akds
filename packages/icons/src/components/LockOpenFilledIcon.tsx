...
export interface LockOpenFilledIconProps extends Omit<React.SVGProps<SVGSVGElement>, 'width' | 'height' | 'color'> {
...
export const LockOpenFilledIcon = React.forwardRef<SVGSVGElement, LockOpenFilledIconProps>(
  function LockOpenFilledIcon({ size = 'md', color = 'default', className, style, ...props }, ref) {
