...
export interface DarkModeFilledIconProps extends Omit<React.SVGProps<SVGSVGElement>, 'width' | 'height' | 'color'> {
...
export const DarkModeFilledIcon = React.forwardRef<SVGSVGElement, DarkModeFilledIconProps>(
  function DarkModeFilledIcon({ size = 'md', color = 'default', className, style, ...props }, ref) {
    ...
    return (
      <svg
        ...
        {...props}
      >
        <path d="M480-120q-150 0-255-105T120-480q0-135 79.5-229T408-830q20-5 34-1t22 15q8 10 7.5 25t-8.5 35q-9 23-14 47t-5 49q0 90 63 153t153 63q25 0 48.5-4.5T754-461q22-8 38-7t26 9q10 8 13 23t-2 36q-27 121-121 200.5T480-120Z" />
      </svg>
    );
  },
);

DarkModeFilledIcon.displayName = 'DarkModeFilledIcon';
