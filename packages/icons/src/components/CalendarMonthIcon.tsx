...
export interface CalendarMonthIconProps extends Omit<React.SVGProps<SVGSVGElement>, 'width' | 'height' | 'color'> {
...
export const CalendarMonthIcon = React.forwardRef<SVGSVGElement, CalendarMonthIconProps>(
  function CalendarMonthIcon({ size = 'md', color = 'default', className, style, ...props }, ref) {
