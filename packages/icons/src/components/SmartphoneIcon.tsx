...
export interface SmartphoneIconProps extends Omit<React.SVGProps<SVGSVGElement>, 'width' | 'height' | 'color'> {
...
export const SmartphoneIcon = React.forwardRef<SVGSVGElement, SmartphoneIconProps>(
  function SmartphoneIcon({ size = 'md', color = 'default', className, style, ...props }, ref) {
