...
export interface KeyboardArrowDownIconProps extends Omit<React.SVGProps<SVGSVGElement>, 'width' | 'height' | 'color'> {
...
export const KeyboardArrowDownIcon = React.forwardRef<SVGSVGElement, KeyboardArrowDownIconProps>(
  function KeyboardArrowDownIcon({ size = 'md', color = 'default', className, style, ...props }, ref) {
