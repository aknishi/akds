...
export interface PrintIconProps extends Omit<React.SVGProps<SVGSVGElement>, 'width' | 'height' | 'color'> {
...
export const PrintIcon = React.forwardRef<SVGSVGElement, PrintIconProps>(
  function PrintIcon({ size = 'md', color = 'default', className, style, ...props }, ref) {
