...
export interface LockFilledIconProps extends Omit<React.SVGProps<SVGSVGElement>, 'width' | 'height' | 'color'> {
...
export const LockFilledIcon = React.forwardRef<SVGSVGElement, LockFilledIconProps>(
  function LockFilledIcon({ size = 'md', color = 'default', className, style, ...props }, ref) {
