...
export interface SunnyIconProps extends Omit<React.SVGProps<SVGSVGElement>, 'width' | 'height' | 'color'> {
...
export const SunnyIcon = React.forwardRef<SVGSVGElement, SunnyIconProps>(
  function SunnyIcon({ size = 'md', color = 'default', className, style, ...props }, ref) {
