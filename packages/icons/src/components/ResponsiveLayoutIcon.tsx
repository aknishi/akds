...
export interface ResponsiveLayoutIconProps extends Omit<React.SVGProps<SVGSVGElement>, 'width' | 'height' | 'color'> {
...
export const ResponsiveLayoutIcon = React.forwardRef<SVGSVGElement, ResponsiveLayoutIconProps>(
  function ResponsiveLayoutIcon({ size = 'md', color = 'default', className, style, ...props }, ref) {
