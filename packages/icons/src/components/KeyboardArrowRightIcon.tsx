...
export interface KeyboardArrowRightIconProps extends Omit<React.SVGProps<SVGSVGElement>, 'width' | 'height' | 'color'> {
...
export const KeyboardArrowRightIcon = React.forwardRef<SVGSVGElement, KeyboardArrowRightIconProps>(
  function KeyboardArrowRightIcon({ size = 'md', color = 'default', className, style, ...props }, ref) {
