...
export interface ZoomOutIconProps extends Omit<React.SVGProps<SVGSVGElement>, 'width' | 'height' | 'color'> {
...
export const ZoomOutIcon = React.forwardRef<SVGSVGElement, ZoomOutIconProps>(
  function ZoomOutIcon({ size = 'md', color = 'default', className, ...props }, ref) {
