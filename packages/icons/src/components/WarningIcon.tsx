...
export interface WarningIconProps extends Omit<React.SVGProps<SVGSVGElement>, 'width' | 'height' | 'color'> {
...
export const WarningIcon = React.forwardRef<SVGSVGElement, WarningIconProps>(
  function WarningIcon({ size = 'md', color = 'default', className, style, ...props }, ref) {
