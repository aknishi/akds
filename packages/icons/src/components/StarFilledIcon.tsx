...
export interface StarFilledIconProps extends Omit<React.SVGProps<SVGSVGElement>, 'width' | 'height' | 'color'> {
...
export const StarFilledIcon = React.forwardRef<SVGSVGElement, StarFilledIconProps>(
  function StarFilledIcon({ size = 'md', color = 'default', className, ...props }, ref) {
