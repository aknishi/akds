...
export interface AnimationFilledIconProps extends Omit<React.SVGProps<SVGSVGElement>, 'width' | 'height' | 'color'> {
...
export const AnimationFilledIcon = React.forwardRef<SVGSVGElement, AnimationFilledIconProps>(
  function AnimationFilledIcon({ size = 'md', color = 'default', className, style, ...props }, ref) {
