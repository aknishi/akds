...
export interface PublicFilledIconProps extends Omit<React.SVGProps<SVGSVGElement>, 'width' | 'height' | 'color'> {
...
export const PublicFilledIcon = React.forwardRef<SVGSVGElement, PublicFilledIconProps>(
  function PublicFilledIcon({ size = 'md', color = 'default', className, style, ...props }, ref) {
...
PublicFilledIcon.displayName = 'PublicFilledIcon';
