...
export interface InfoIconProps extends Omit<React.SVGProps<SVGSVGElement>, 'width' | 'height' | 'color'> {
...
export const InfoIcon = React.forwardRef<SVGSVGElement, InfoIconProps>(
  function InfoIcon({ size = 'md', color = 'default', className, style, ...props }, ref) {
