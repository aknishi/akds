...
export interface GroupFilledIconProps extends Omit<React.SVGProps<SVGSVGElement>, 'width' | 'height' | 'color'> {
...
export const GroupFilledIcon = React.forwardRef<SVGSVGElement, GroupFilledIconProps>(
  function GroupFilledIcon({ size = 'md', color = 'default', className, style, ...props }, ref) {
