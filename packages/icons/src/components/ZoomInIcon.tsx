...
export interface ZoomInIconProps extends Omit<React.SVGProps<SVGSVGElement>, 'width' | 'height' | 'color'> {
...
export const ZoomInIcon = React.forwardRef<SVGSVGElement, ZoomInIconProps>(
  function ZoomInIcon({ size = 'md', color = 'default', className, style, ...props }, ref) {
