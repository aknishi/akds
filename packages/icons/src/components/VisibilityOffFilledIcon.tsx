...
export interface VisibilityOffFilledIconProps extends Omit<React.SVGProps<SVGSVGElement>, 'width' | 'height' | 'color'> {
...
export const VisibilityOffFilledIcon = React.forwardRef<SVGSVGElement, VisibilityOffFilledIconProps>(
  function VisibilityOffFilledIcon({ size = 'md', color = 'default', className, style, ...props }, ref) {
