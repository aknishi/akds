...
export interface KeyboardArrowUpIconProps extends Omit<React.SVGProps<SVGSVGElement>, 'width' | 'height' | 'color'> {
...
export const KeyboardArrowUpIcon = React.forwardRef<SVGSVGElement, KeyboardArrowUpIconProps>(
  function KeyboardArrowUpIcon({ size = 'md', color = 'default', className, style, ...props }, ref) {
