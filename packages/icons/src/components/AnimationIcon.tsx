...
export interface AnimationIconProps extends Omit<React.SVGProps<SVGSVGElement>, 'width' | 'height' | 'color'> {
...
export const AnimationIcon = React.forwardRef<SVGSVGElement, AnimationIconProps>(
  function AnimationIcon({ size = 'md', color = 'default', className, style, ...props }, ref) {
