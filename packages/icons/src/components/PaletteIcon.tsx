...
export interface PaletteIconProps extends Omit<React.SVGProps<SVGSVGElement>, 'width' | 'height' | 'color'> {
...
export const PaletteIcon = React.forwardRef<SVGSVGElement, PaletteIconProps>(
  function PaletteIcon({ size = 'md', color = 'default', className, style, ...props }, ref) {
