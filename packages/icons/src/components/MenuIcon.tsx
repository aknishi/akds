...
export interface MenuIconProps extends Omit<React.SVGProps<SVGSVGElement>, 'width' | 'height' | 'color'> {
...
export const MenuIcon = React.forwardRef<SVGSVGElement, MenuIconProps>(
  function MenuIcon({ size = 'md', color = 'default', className, style, ...props }, ref) {
