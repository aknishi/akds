...
export interface WorldIconProps extends Omit<React.SVGProps<SVGSVGElement>, 'width' | 'height' | 'color'> {
...
export const WorldIcon = React.forwardRef<SVGSVGElement, WorldIconProps>(
  function WorldIcon({ size = 'md', color = 'default', className, style, ...props }, ref) {
