...
export interface OpenInNewIconProps extends Omit<React.SVGProps<SVGSVGElement>, 'width' | 'height' | 'color'> {
...
export const OpenInNewIcon = React.forwardRef<SVGSVGElement, OpenInNewIconProps>(
  function OpenInNewIcon({ size = 'md', color = 'default', className, style, ...props }, ref) {
