...
const COMPONENT_KEYWORDS: Record<string, string[]> = {
  ...
  'streaming-text': ['typewriter', 'text reveal', 'token streaming'],
  'generation-loader': ['loading dots', 'typing indicator', 'ai loading'],
  'thinking-state': ['reasoning', 'chain of thought', 'ai status'],
